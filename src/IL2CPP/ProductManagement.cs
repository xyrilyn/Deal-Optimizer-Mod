...
namespace DealOptimizer_IL2CPP
{
	public partial class Core
	{
        ...
        void DrawProductWindowContents(int windowId)
        {
            ...
            GUILayout.BeginHorizontal("Selected Price");
            GUILayout.FlexibleSpace();
            GUILayout.Label($"Asking Price: ${selectedProductForEvaluation.Price}", productInfoSubHeaderStyle);
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
            GUILayout.EndHorizontal();
            ...
            GUILayout.FlexibleSpace();
            if (GUILayout.Button(toolbarModes[0], GUILayout.Width(140), GUILayout.Height(26)))
            {
                toolbarMode = 0;
                EvaluateProductForAllCustomers(selectedProductForEvaluation);
            }
            if (GUILayout.Button(toolbarModes[1], GUILayout.Width(140), GUILayout.Height(26)))
            {
                toolbarMode = 1;
                EvaluateProductForAllCustomers(selectedProductForEvaluation);
            }
            ...
            GUILayout.FlexibleSpace();
            if (GUILayout.Button(toolbarSortings[0], GUILayout.Width(93), GUILayout.Height(26)))
            {
                toolbarSorting = 0;
                EvaluateProductForAllCustomers(selectedProductForEvaluation);
            }
            if (GUILayout.Button(toolbarSortings[1], GUILayout.Width(93), GUILayout.Height(26)))
            {
                toolbarSorting = 1;
                EvaluateProductForAllCustomers(selectedProductForEvaluation);
            }
            if (GUILayout.Button(toolbarSortings[2], GUILayout.Width(93), GUILayout.Height(26)))
            {
                toolbarSorting = 2;
                EvaluateProductForAllCustomers(selectedProductForEvaluation);
            }
        ...
        static class ProductManagerAppPostfixSelectProduct
        {
            ...
            {
                if (!ModConfiguration.ProductEvaluatorEnabled.Value)
                {
                    return;
                }
